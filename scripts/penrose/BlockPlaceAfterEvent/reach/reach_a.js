import { world, Player, system, MinecraftBlockTypes, Block } from "@minecraft/server";
import config from "../../../data/config.js";
import { flag } from "../../../util.js";
import { dynamicPropertyRegistry } from "../../WorldInitializeAfterEvent/registry.js";
// Store the previous locations and velocities of player and block
const previousData = new Map();
function recordPlayerData(entity) {
...
function isWithinReach(previousblockData, previousplayerData, currentblockLocation, currentplayerLocation) {
...
function calculateDistanceSquared(position1, position2) {
    const dx = position2.x - position1.x;
    const dy = position2.y - position1.y;
    const dz = position2.z - position1.z;
    return dx * dx + dy * dy + dz * dz;
}
function calculateReachDistanceWithVelocity(previousplayerData, previousblockData, currentplayerLocation, currentblockLocation) {
...
function resetReachDistance(player) {
