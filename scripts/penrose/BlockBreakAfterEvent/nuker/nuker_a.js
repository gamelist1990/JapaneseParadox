...
async function nukera(object) {
    ...
    const itemEnchantmentComponent = item?.getComponent("enchantments");
...
function freeze(id) {
    ...
    for (const player of players) {
        ...
        player.onScreenDisplay.setTitle("§f§4[§6Paradox§4]§f違法な動きを検知しました", { subtitle: "§f検知内容＝＞ §4[§6AntiNukerA§4]§f", fadeInDuration: 0, fadeOutDuration: 0, stayDuration: 60 });
    }
}
const NukerA = () => {
