 ...
 */
export function uiANTIKNOCKBACK(antiknockbackResult, player) {
...
async function handleUIAntiKnockback(antiknockbackResult, player) {
    ...
    if (uniqueId !== player.name) {
        return sendMsgToPlayer(player, `§f§4[§6Paradox§4]§f 管理者しか実行できません to configure Anti Knockback`);
    }
