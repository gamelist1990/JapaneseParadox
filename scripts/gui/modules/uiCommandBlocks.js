 ...
 */
export function uiCOMMANDBLOCKS(commandblocksResult, player) {
...
async function handleUICommandBlocks(commandblocksResult, player) {
    ...
    if (uniqueId !== player.name) {
        return sendMsgToPlayer(player, `§f§4[§6Paradox§4]§f 管理者しか実行できません to configure Command Blocks`);
    }
