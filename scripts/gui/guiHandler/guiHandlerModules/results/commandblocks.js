...
export function commandBlocksHandler(player) {
    ...
    modulescommandblocksui.title("§4コマブロ§4");
                        modulescommandblocksui.toggle("Override Command Blocks - commandblocksenabled gameruleを常に有効または無効にします：", cmdoBoolean);
                        modulescommandblocksui.toggle("アンチコマンドブロック（Anti Command Blocks） - 有効にすると、すべてのコマンドブロックをクリアする：", removecmdblocksBoolean);
